...
{0,
{"Описание оповещения",0,1,"Опи[сание] оповещения","&НаКлиенте
Процедура ОписаниеОповещения<?""Введите название"">(Значение, Доп) Экспорт 
...
{"Константы",1,0,"",""},
{0,
{"Получить/установить",0,0,"Конст[ант]ы","Константы.<?"""", Константа>.<?""Выбор метода"", ВыборВарианта, ""Получить"", ""Получить"", ""Установить"", ""Установить"">()"}
}
},
{5,
{"Справочники",1,0,"",""},
...
{0,
{"#Если",0,0,"№Ес[ли]","#Если <?"""", ВыборВарианта, ""Клиент"", ""Клиент"",	
							""На клиенте"", ""НаКлиенте"",								
							""Сервер"", ""Сервер"",							
							""На сервере"", ""НаСервере"",
							""Тонкий клиент"", ""ТонкийКлиент"",
...
{"Даты время",1,0,"",""},
{0,
{"Начало месяца",0,0,"НМ","НачалоМесяца(<?>)"}
},
{0,
{"Конец месяца",0,0,"КМ","КонецМесяца(<?>)"}
},
{0,
{"Начало дня",0,0,"НД","НачалоДня(<?>)"}
},
{0,
{"Конец дня",0,0,"КД","КонецДня(<?>)"}
},
{0,
{"Текущая дата",0,0,"ТД","ТекущаяДата()"}
}
},
{4,
{"Периоды",1,0,"",""},
...
{"Специфические",1,0,"",""},
{0,
{"Новый уникальный идентификатор",0,0,"НУИ","Новый УникальныйИдентификатор"}
},
{0,
{"Запись в журнал регистрации",0,0,"ЗЖР","ЗаписьЖурналаРегистрации(<?>""Событие"",
...
{0,
{"Обмен данными загрузка",0,0,"обз","ОбменДанными.Загрузка = Истина<?>"}
},
{0,
...
{0,
{"Значение заполнено",0,0,"ЗЗ","ЗначениеЗаполнено(<?>)"}
},
{0,
{"Заполнить значения свойств",0,0,"ЗЗС","ЗаполнитьЗначенияСвойств(<?>,);"}
},
{0,
...
{0,
{"Получить объект",0,0,"поб","ПолучитьОбъект()<?>"}
},
{0,
